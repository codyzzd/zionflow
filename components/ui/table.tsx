...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b border-border transition-colors hover:bg-stone-50 has-aria-expanded:bg-stone-100 data-[state=selected]:bg-stone-100 dark:hover:bg-stone-800/50 dark:has-aria-expanded:bg-stone-800 dark:data-[state=selected]:bg-stone-800",
        className
      )}
      {...props}
    />
